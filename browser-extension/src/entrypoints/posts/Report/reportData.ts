...
export function getTitlePublicationHeader(date: PublicationDate | undefined): string {
...
export function getLabelPublishedComment(date: PublicationDate | undefined): string {
